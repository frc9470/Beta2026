...
public class IntakeConstants {
    ...
    public static final Angle kAgitateMiddleAngle = Degrees.of(80.0); // Upper compression target during shot agitation
    ...
    public static final double kShootAgitationDelaySec = 1;
