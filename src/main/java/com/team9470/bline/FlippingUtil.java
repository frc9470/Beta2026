...
public class FlippingUtil {
  ...
  public enum FieldSymmetry {
    /**
     * Field is rotationally symmetric. i.e. the red alliance side is the blue
     * alliance side rotated
     * by 180 degrees
     */
    kRotational,
  ...
  /**
   * Mirror a field position across the field width centerline, maintaining a blue
   * alliance origin.
   *
   * <p>
   * This performs {@code y -> fieldSizeY - y} while leaving {@code x} unchanged.
   *
  ...
  /**
   * Mirror a field rotation across the field width centerline, maintaining a blue
   * alliance origin.
   *
   * <p>
   * This performs {@code theta -> -theta}.
   *
  ...
  /**
   * Mirror a field pose across the field width centerline, maintaining a blue
   * alliance origin.
   *
  ...
  /**
   * Flip field relative chassis speeds for the other side of the field,
   * maintaining a blue alliance
   * origin
   *
  ...
  /**
   * Flip an array of drive feedforwards for the other side of the field. Only
   * does anything if
  ...
  /**
   * Flip an array of drive feedforward X components for the other side of the
   * field. Only does
  ...
  /**
   * Flip an array of drive feedforward Y components for the other side of the
   * field. Only does
   * anything if mirrored symmetry is used
   *
